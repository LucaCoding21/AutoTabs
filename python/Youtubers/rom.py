...
def process_frame(frame, frame_count, last_save_time):
    ...
    green_value = g[577, 130]  # Assuming the coordinates are within the frame dimensions
    blue_value = b[577, 130]
    red_value = r[577, 130]
    ...
    if (green_value == 147 or green_value == 141 or green_value == 138) or (green_value >=100 and green_value <= 200):
...
# Open the video file
cap = cv2.VideoCapture('./videos/here.mp4')

...
def process_frame(frame, frame_count, last_save_time):
    ...
    green_value = g[530, 1179]  # Assuming the coordinates are within the frame dimensions
    blue_value = b[530,1179]
    red_value = r[530,1179]
...
# Open the video file
cap = cv2.VideoCapture('./videos/vidp.mp4')
